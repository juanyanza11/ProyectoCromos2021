                    ...
                    <div class="region region-footer">
                        ...
                        <div id="block-block-4" class="block block-block foot-logo">
                            ...
                            <section class="blocks" id="Logo">
                                ...
                                <div class="content">
                                    <div id="logo">
                                        <p><img alt="" src="{{asset('/img/footer/logo-utpl.png')}}" /></p>
                                    </div>
                                </div>
                            </section>
                        </div> <!-- /.block -->
                        ...
                        <div id="block-block-3" class="block block-block contactos">
                            ...
                            <section class="blocks" id="contactos">
                                ...
                                <div class="content">
                                    ...
                                    <p><img alt="" src="{{asset('/img/footer/icon-ubicacion.png')}}" style="height:18px; width:18px" />&nbsp San Cayetano Alto - Loja</p>
                                    <p><img alt="" src="{{asset('/img/footer/icon-ubicacion.png')}}" style="height:18px; width:18px" /><a href="https://utpl.edu.ec/centros/">&nbsp Centros UTPL</a></p>
                                    <p><a href="https://utpl.edu.ec/buzon"><img alt="" src="{{asset('/img/footer/icon-buzon.png')}}" style="width: 18px; height: 18px;" />&nbsp Buzón de consultas</a></p>
                                    <p><img alt="" src="{{asset('/img/footer/icon-calll-center.png')}}" style="width: 18px; height: 18px;" />&nbsp 1800 88 75 88</p>
                                    <p><a href="https://api.whatsapp.com/send?phone=593999565400&amp;text=%C2%A1Hola!%20"><img alt="" src="{{asset('/img/footer/icon-whatsapp.png')}}" style="width: 18px; height: 18px;" />&nbsp WhatsApp: 0999565400</a></p>
                                    <p><img alt="" src="{{asset('/img/footer/icon-telefono.png')}}" style="height:18px; width:18px" />&nbsp PBX: 07 370 1444</p>
                                    <p> </p>
                                </div>
                            </section>
                        </div> <!-- /.block -->
